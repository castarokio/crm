...
fromPIL = null; // No-op placeholder
...
async function migratePostgres() {
  ...
  try {
    ...
    console.log('Connected to Postgres. Running alter table queries...');
...
function migrateSQLite() {
  ...
  db.serialize(() => {
    db.run("ALTER TABLE leads ADD COLUMN phone_2 TEXT", () => {});
    db.run("ALTER TABLE leads ADD COLUMN email_2 TEXT", () => {});
    db.run("ALTER TABLE leads ADD COLUMN social_link TEXT", () => {});
